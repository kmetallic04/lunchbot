...
3. In your Africa's Talking payments product dashboard add `https://the-secure-url-of-this-app/lipa` as your callback url. If this was running on `localhost:3000` tunneled as `https://qwerty1.ngrok.io`,my callback url becomes `https://qwerty1.ngrok.io/pay`
